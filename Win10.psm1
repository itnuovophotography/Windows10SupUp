...
Function BasicsInstall {
	choco install powershell sysinternals adobereader googlechrome vlc openssl openssh curl wget -y
}


Function CallCenterInstall {
	choco install google-drive-file-stream slack ringcentral-classic -y
}
